...
const Request = () => {
    ...
    const onChangeTerm = useCallback((e)=>{
      ...
      },[selectedButton, selectedBuyTypeButton, eumpmeon, lia, address, price, selectedLandTypeButton, name, title, contact, textDetail, term, dispatch]);
                    ...
                    <Space direction='vertical'>
                        ...
                        <List.Item style={{ borderBlockEnd:'none' }}>
                            ...
                            <List.Item style={{ borderBlockEnd:'none' }}>
                                <div>
                                    <h2>개인정보 수집 안내</h2>
                                    <aside style={{ width:'85vw', height:'20vh', overflowY: 'scroll', border: '1px solid silver', padding:'10px', borderRadius:'10px'}}>
